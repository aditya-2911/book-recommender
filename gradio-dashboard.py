...
embedding_function = HuggingFaceEndpointEmbeddings(
    huggingfacehub_api_token=my_key, # <-- New parameter name
...
with gr.Blocks(theme= gr.themes.Citrus()) as dashboard:
    ...
    with gr.Row():
        user_query = gr.Textbox(label="Enter a book description",
                                placeholder="e.g., A stroy about friendship and adventure...")
        category_dropdown = gr.Dropdown(choices=categories, value="All", label="Select Category")
        tone_dropdown = gr.Dropdown(choices=tones, value="All", label="Select Tone")
